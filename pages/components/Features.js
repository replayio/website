    ...
    <main className="bg-white space-y-16" style={{ paddingTop: "360px" }}>
      ...
      <div className="pt-6 pb-24 sm:py-4">
        <FeatureGroup title="Debug with DevTools">
          <Feature
            title={``}
            content={`With Replay, you can view console logs, inspect elements, and even add print statements after the fact. It's all there so you can find and fix bugs faster.`}
